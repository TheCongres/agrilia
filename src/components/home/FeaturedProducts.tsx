              ...
              return (
                <CarouselItem key={product.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                  <Link 
                    ...
                    className="card-organic group block"
                  >
                    <div className="aspect-[4/3] relative overflow-hidden">
                      ...
                      <button
                        ...
                        className={cn(
                          "absolute top-3 left-3 h-8 w-8 rounded-full flex items-center justify-center transition-colors z-10",
                          isFavorite 
                    ...
                    <div className="p-4">
                      ...
                      <h3 className="font-medium text-earth-700 mb-1 group-hover:text-natural-600 transition-colors line-clamp-2">
                        {product.name}
                      </h3>
